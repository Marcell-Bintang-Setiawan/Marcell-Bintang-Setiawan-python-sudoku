...
def get_sudoku():  # Program UTAMA
    ...
    l1 = tr.Label(window, text='SUDOKU SOLVER MENGGUNAKAN ALGORITMA BACKTRACKING', bg='white', font=('Arial', 9))  # Judul
    l1.place(x='10', y='15')
    ...
    def get_data():  
        # Membaca nilai matriks Sudoku dan lakukan operasi
        for e in entrys:
        ...
        # Cek apakah data entry valid atau tidak
        if ceksudoku(sudoku):  
            # Substitusi inputan Sudoku ke dalam algoritma untuk menghitung
            data = sudoku  
...
# Langkah Pertama, untuk menentukan apakah nomor tersebut diulang, apakah boleh diisi
...
# Langkah Kedua, dicoba secara berurutan pada posisi dengan beberapa nomor kandidat. Mirip dengan algoritma depth-first traversal(DFT), jika hasil angka pada posisi tertentu adalah True, tebakan posisi berikutnya diperbolehkan; jika posisi tertentu False, maka akan diabaikan.
